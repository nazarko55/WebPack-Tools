...
describe('createItem function test', function () {
  var taskItem = null;
  beforeEach(function () {
    var taskData = {
      id: "1",
  ...
  it('Task item should contain textContent node', function () {
    expect(taskItem.textContent).toBe('Task 1');
  });
  it('Task item should data-attribute-id ', function () {
    expect(taskItem.dataset.id).toBe('1');
  });
  it('Task item should not contain class "list__item_done"', function () {
